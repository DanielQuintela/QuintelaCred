...
router.post('/', authMiddleware, adminMiddleware, validateDto(CreateLocationSchema), controller.create)
router.get('/', authMiddleware, controller.findMany)
router.get('/find', authMiddleware, controller.findExisting)
router.get('/:id', authMiddleware, controller.findById)
router.put('/:id', authMiddleware, adminMiddleware, validateDto(CreateLocationSchema), controller.update)
